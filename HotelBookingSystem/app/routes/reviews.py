...
from app.utils.images_util import create_image, hard_delete_image, get_images_for_review
...
async def respond_review(
    ...
    **Authorization:** Requires CONTENT_MANAGEMENT:WRITE permission AND ADMIN role.
    ...
    Args:
        ...
        _permissions (dict): CONTENT_MANAGEMENT:WRITE permission check.
    
    Returns:
        ReviewResponse: Updated review with admin_response field populated.
    
    Raises:
        HTTPException (403): If user lacks CONTENT_MANAGEMENT:WRITE permission.
        HTTPException (404): If review_id not found.
