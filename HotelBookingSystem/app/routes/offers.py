...
from app.services.offers_service import create_offer as svc_create_offer, get_offer as svc_get_offer, list_offers as svc_list_offers
from app.services.offers_service import update_offer as svc_update_offer, soft_delete_offer as svc_soft_delete_offer
