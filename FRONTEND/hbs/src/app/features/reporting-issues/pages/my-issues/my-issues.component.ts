...
export class MyIssuesComponent implements OnInit, OnDestroy {
  ...
  loadIssues(): void {
    ...
    this.issuesService
      .getMyIssues(50, 0, status, room_id, search, date_from, date_to, this.sortBy)
  ...
  viewIssueDetails(issueId: number): void {
    this.router.navigate(['/issues/details', issueId]);
  }

  editIssue(issueId: number): void {
    this.router.navigate(['/issues/edit', issueId]);
  }
